...
const Credentials = (props: Props) => {
  ...
  return (
    <div className="flex flex-col w-full border-opacity-50 pb-2">
      ...
      <button
   className="btn btn-secondary btn-outline w-full max-w-xs mx-auto text-accent my-4"              onClick={() => setLogin((prevState) => !prevState)}
            >
      ...
      <button
   className="btn btn-secondary btn-outline w-full max-w-xs mx-auto text-accent"            onClick={()=> signIn("google")} disabled
          >
